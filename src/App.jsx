  ...
  const renderAbout = () => (
    <div className="about-container">
      ...
      <section className="about-section">
        ...
        <p>
          Crypto Glance is a modern, responsive web application that provides real-time 
          ...
          the crypto market with advance filtering, sorting, and multiple view modes.
        </p>
        <p>
  ...
  return (
    <div className="app">
      ...
      <footer className="footer">
        <p>© {new Date().getFullYear()} Crypto Glance Tracker. Data provided by CoinGecko API.</p>
      </footer>
    </div>
  );
}
