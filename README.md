...
- **Tejaswi** - Project Lead & Frontend Development
- **Siva** - Frontend Architecture & Component Design
- **Sadhgun** - API Integration & Data Management
- **Nuthan** - UI/UX Design & Styling
- **Tushar** - Testing & Optimization
